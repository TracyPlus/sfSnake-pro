...
// const sf::Color Game::Color::Purple = sf::Color(0xf1c40fff);
const sf::Color Game::Color::DarkBlue = sf::Color(91,100,133);
const sf::Color Game::Color::Pink = sf::Color(251,219,230);
const sf::Color Game::Color::Purple = sf::Color(181,169,207);

const sf::Color Game::Color::Background[] =
    {
        sf::Color(0xeaeaeaee), // White
        sf::Color(0x747474ff), // Black
        sf::Color(193,178,166)  // Brown
};
...
sf::VideoMode Game::initVideoMode_()
{
    ...
    return sf::VideoMode(
        desktopMode.width / 1.8f,
        desktopMode.height / 1.5f,
